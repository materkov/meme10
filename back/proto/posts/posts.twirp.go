...
func NewPostServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) PostService {
	...
	serviceURL += baseServicePath(pathPrefix, "socialnet", "PostService")
	urls := [3]string{
		serviceURL + "AddPost",
...
func (c *postServiceProtobufClient) AddPost(ctx context.Context, in *AddPostRequest) (*AddPostResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "socialnet")
	ctx = ctxsetters.WithServiceName(ctx, "PostService")
	ctx = ctxsetters.WithMethodName(ctx, "AddPost")
	caller := c.callAddPost
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *AddPostRequest) (*AddPostResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*AddPostRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*AddPostRequest) when calling interceptor")
					}
					return c.callAddPost(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*AddPostResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*AddPostResponse) when calling interceptor")
				}
...
func (c *postServiceProtobufClient) callAddPost(ctx context.Context, in *AddPostRequest) (*AddPostResponse, error) {
...
func (c *postServiceProtobufClient) GetFeed(ctx context.Context, in *GetFeedRequest) (*GetFeedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "socialnet")
	ctx = ctxsetters.WithServiceName(ctx, "PostService")
	ctx = ctxsetters.WithMethodName(ctx, "GetFeed")
	caller := c.callGetFeed
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *GetFeedRequest) (*GetFeedResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetFeedRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*GetFeedRequest) when calling interceptor")
					}
					return c.callGetFeed(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetFeedResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*GetFeedResponse) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *postServiceProtobufClient) callGetFeed(ctx context.Context, in *GetFeedRequest) (*GetFeedResponse, error) {
...
func (c *postServiceJSONClient) AddPost(ctx context.Context, in *AddPostRequest) (*AddPostResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "socialnet")
	ctx = ctxsetters.WithServiceName(ctx, "PostService")
	ctx = ctxsetters.WithMethodName(ctx, "AddPost")
	caller := c.callAddPost
...
func (c *postServiceJSONClient) callAddPost(ctx context.Context, in *AddPostRequest) (*AddPostResponse, error) {
	out := new(AddPostResponse)
...
func (c *postServiceJSONClient) GetFeed(ctx context.Context, in *GetFeedRequest) (*GetFeedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "socialnet")
	ctx = ctxsetters.WithServiceName(ctx, "PostService")
	ctx = ctxsetters.WithMethodName(ctx, "GetFeed")
	caller := c.callGetFeed
...
func (c *postServiceJSONClient) callGetFeed(ctx context.Context, in *GetFeedRequest) (*GetFeedResponse, error) {
	out := new(GetFeedResponse)
...
const PostServicePathPrefix = "/twirp/socialnet.PostService/"
...
func (s *postServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "socialnet.PostService" {
...
func (s *postServiceServer) serveAddPost(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveAddPostJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveAddPostProtobuf(ctx, resp, req)
	default:
...
func (s *postServiceServer) serveAddPostJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddPost")
	...
	handler := s.PostService.AddPost
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *AddPostRequest) (*AddPostResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.PostService.AddPost(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*AddPostResponse)
	...
	// Call service method
	var respContent *AddPostResponse
	func() {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *AddPostResponse and nil error while calling AddPost. nil responses are not supported"))
		return
	}
...
func (s *postServiceServer) serveAddPostProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddPost")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *postServiceServer) serveGetFeed(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *postServiceServer) serveGetFeedJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetFeed")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.PostService.GetFeed
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *GetFeedRequest) (*GetFeedResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetFeedRequest)
					if !ok {
					...
					return s.PostService.GetFeed(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetFeedResponse)
	...
	// Call service method
	var respContent *GetFeedResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = handler(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *GetFeedResponse and nil error while calling GetFeed. nil responses are not supported"))
		return
	}
...
func (s *postServiceServer) serveGetFeedProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetFeed")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
